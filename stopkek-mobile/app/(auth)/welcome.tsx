...
const SLIDES = [
  { title: 'Никто не мешает', desc: 'Никаких администраторов рядом — ты сам себе хозяин' },
  { title: 'Своя соло-комната', desc: 'Закрытая капсула с мощным ПК, удобным креслом и всем нужным' },
  { title: 'Всё под рукой', desc: 'Бронь, вход и таймер — прямо в телефоне, без лишних шагов' },
];
