...
export default function VerifyCallcheckScreen() {
  ...
  return (
    <Screen scroll>
      ...
      <Text style={[typography.h1, styles.center]}>Позвоните нам</Text>
      <Text style={[typography.bodySecondary, styles.center, styles.mb]}>
        С номера {phone || 'вашего телефона'} на указанный ниже. Дождитесь сброса — вход
      ...
      {waiting ? (
        <Text style={[typography.caption, styles.center]}>
          Ожидаем звонок… {expiresInSec > 0 ? `(${mmss(expiresInSec)})` : ''}
        </Text>
      ) : null}
...
const styles = StyleSheet.create({
  ...
  iconWrap: { alignItems: 'center', justifyContent: 'center', height: 100, marginVertical: spacing.lg },
  iconCircle: {
    width: 72,
    height: 72,
    borderRadius: 36,
